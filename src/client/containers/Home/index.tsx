...
const { lazy, useContext,useState } = React;
const { TabPane } = Tabs;
...
const Home: React.FunctionComponent<RouteComponentProps> = () => {
  ...
  const changeProps=()=>{
    testData.push(testData.length)
    setTestData([].concat(testData))
  }

  return (
    <Content className="content">
      <button onClick={changeProps}>change testData</button>
      <div className="content-section">
        <CurrentHouse testData={testData}/>
      </div>
